 ...
 * consulted me.
 */
public class SpotLight2 extends LayerUI<JComboBox>{
    ...
    @Override
    protected void processMouseEvent(MouseEvent e, JLayer<? extends JComboBox> l) {
    ...
    @Override
    protected void processMouseMotionEvent(MouseEvent e, JLayer<? extends JComboBox> l) {
